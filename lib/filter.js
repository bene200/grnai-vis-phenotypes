          ...
          <div class='row' style='margin-bottom: 0;'>
            ...
            <div class='col-md-4' style='padding-top: 0; padding-bottom: 0;'>
              <ul style="list-style-type: none; padding-left: 0px;">
                <li><a href="http://www.genomernai.org/v16/uniprotLinkout/${encodeURI(pn.data().name)}/${this.expId}" style='font-size: 8pt; color: #5cb534'
                ...
                >StringDB</a></li>
                <li><a href="http://www.genomernai.org/v16/download/phenotypes/uniprot/${encodeURI(pn.data().name)}/${this.expId}" style='font-size: 8pt; color: #5cb534'
